                    ...
                    if (!empty($statistics)) {
                        ...
                        <div class="row">
                            <div class="span12">
                                ...
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_missing_cuisine_5_count.png' />\n";
                                echo "<p>Küchnaushilfe: <span class='value'>" . $statistics['fix_count_missing_cuisine_5'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_missing_cuisine_50_count.png' />\n";
                                echo "<p>Gourmet: <span class='value'>" . $statistics['fix_count_missing_cuisine_50'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_missing_cuisine_100_count.png' />\n";
                                echo "<p>Küchenchef: <span class='value'>" . $statistics['fix_count_missing_cuisine_100'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_missing_level_5_count.png' />\n";
                                echo "<p>5 Stockwerk Missionen: <span class='value'>" . $statistics['fix_count_missing_level_5'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_missing_level_50_count.png' />\n";
                                echo "<p>50 Stockwerk Missionen: <span class='value'>" . $statistics['fix_count_missing_level_50'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_missing_level_100_count.png' />\n";
                                echo "<p>100 Stockwerk Missionen: <span class='value'>" . $statistics['fix_count_missing_level_100'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_missing_maxspeed_5_count.png' />\n";
                                echo "<p>5 Tempolimit-Missionen: <span class='value'>" . $statistics['fix_count_missing_maxspeed_5'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_missing_maxspeed_50_count.png' />\n";
                                echo "<p>50 Tempolimit-Missionen: <span class='value'>" . $statistics['fix_count_missing_maxspeed_50'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_missing_maxspeed_100_count.png' />\n";
                                echo "<p>100 Tempolimit-Missionen: <span class='value'>" . $statistics['fix_count_missing_maxspeed_100'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_missing_track_type_5_count.png' />\n";
                                echo "<p>5 Wegtyp-Missionen: <span class='value'>" . $statistics['fix_count_missing_track_type_5'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_missing_track_type_50_count.png' />\n";
                                echo "<p>50 Wegtyp-Missionen: <span class='value'>" . $statistics['fix_count_missing_track_type_50'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_missing_track_type_100_count.png' />\n";
                                echo "<p>100 Wegtyp-Missionen: <span class='value'>" . $statistics['fix_count_missing_track_type_100'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_motorway_ref_5_count.png' />\n";
                                echo "<p>5 Autobahn-Missionen: <span class='value'>" . $statistics['fix_count_motorway_ref_5'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_motorway_ref_50_count.png' />\n";
                                echo "<p>50 Autobahn-Missionen: <span class='value'>" . $statistics['fix_count_motorway_ref_50'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_motorway_ref_100_count.png' />\n";
                                echo "<p>100 Autobahn-Missionen: <span class='value'>" . $statistics['fix_count_motorway_ref_100'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_opening_hours_5_count.png' />\n";
                                echo "<p>5 Öffnungszeiten Missionen: <span class='value'>" . $statistics['fix_count_opening_hours_5'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_opening_hours_50_count.png' />\n";
                                echo "<p>50 Öffnungszeiten Missionen: <span class='value'>" . $statistics['fix_count_opening_hours_50'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_opening_hours_100_count.png' />\n";
                                echo "<p>100 Öffnungszeiten Missionen: <span class='value'>" . $statistics['fix_count_opening_hours_100'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_poi_name_5_count.png' />\n";
                                echo "<p>5 Namen-Missionen: <span class='value'>" . $statistics['fix_count_poi_name_5'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_poi_name_50_count.png' />\n";
                                echo "<p>50 Namen-Missionen: <span class='value'>" . $statistics['fix_count_poi_name_50'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_poi_name_100_count.png' />\n";
                                echo "<p>100 Namen-Missionen: <span class='value'>" . $statistics['fix_count_poi_name_100'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_religion_5_count.png' />\n";
                                echo "<p>5 Religion-Missionen: <span class='value'>" . $statistics['fix_count_religion_5'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_religion_50_count.png' />\n";
                                echo "<p>50 Religion-Missionen: <span class='value'>" . $statistics['fix_count_religion_50'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_religion_100_count.png' />\n";
                                echo "<p>100 Religion-Missionen: <span class='value'>" . $statistics['fix_count_religion_100'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_way_wo_tags_5_count.png' />\n";
                                echo "<p>5 Strassenname Missionen: <span class='value'>" . $statistics['fix_count_way_wo_tags_5'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_way_wo_tags_50_count.png' />\n";
                                echo "<p>50 Strassenname Missionen: <span class='value'>" . $statistics['fix_count_way_wo_tags_50'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_way_wo_tags_100_count.png' />\n";
                                echo "<p>100 Strassenname Missionen: <span class='value'>" . $statistics['fix_count_way_wo_tags_100'] . "</span></p>\n";
                                echo "</div>\n";
                                ?>
                            </div>
                        </div>
