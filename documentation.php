                    ...
                    if (!empty($statistics)) {
                        ...
                        <div class="row">
                            <div class="span12">
                                ...
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "six_per_day_count.png' />\n";
                                ...
                                echo "<p>5 Sprache-Missionen: <span class='value'>" . $statistics['fix_count_language_unknown_5_count'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_language_unknown_50.png' />\n";
                                echo "<p>50 Sprache-Missionen: <span class='value'>" . $statistics['fix_count_language_unknown_50_count'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
                                echo "<img src='" . $badgesUrl . "fix_count_language_unknown_100.png' />\n";
                                echo "<p>100 Sprache-Missionen: <span class='value'>" . $statistics['fix_count_language_unknown_100_count'] . "</span></p>\n";
                                echo "</div>\n";
                                echo "<div class='kort-badge'>\n";
